...
<body>
        ...
        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
            ...
            <p align="justify">The "game" is a zero-player game, meaning that its evolution is determined by its initial state, requiring no further input. <br>One interacts with the Game of Life by creating an initial configuration and observing how it evolves, or, for advanced "players", by creating patterns with particular properties.</p>
            <hr>
            <a class="btn btn-success btn-lg" href='StartGame'>Return to the game</a>
        </div>
</body>
</html>
